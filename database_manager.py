...
COMMON_MISPELLING_MAP = {
    ...
    "อนุกรรมาธิกา": "อนุกรรมาธิการ",
    "กรรมาธิกาณ": "กรรมาธิการ",
    "กรรมาธิกา": "กรรมาธิการ",

    # กลุ่ม: คำทั่วไปที่มักพิมพ์ตก
    ...
    "พระราชบัญญัต": "พระราชบัญญัติ",
    "พระราชกฤษฎิกา": "พระราชกฤษฎีกา",
    ...
    "กระทรวงศึกษาธิกา": "กระทรวงศึกษาธิการ",
}
...
def get_engine_lookup_db() -> Dict[str, Dict]:
    ...
    # ผนวกตารางคำทับศัพท์ไทยที่มักสะกดผิด
...
SENATE_EDITORIAL_RULES = [
    ...
    {
        "id": "no_space_before_jamnuan",
        "type": "spacing",
        "wrong_pattern": r"([^\s\d\(\[\{]+)\s+(จำนวน)\s*([\d๑-๙]+)",
        "correct_replacement": r"\1\2 \3",
        "reason": "คำว่า \"จำนวน\" ไม่ต้องเว้นวรรคหน้า ให้พิมพ์ติดกับคำหน้า (เช่น เครื่องสูบน้ำจำนวน ๒,๒๘๙ เครื่อง)",
    },
    {
